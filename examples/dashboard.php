        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-8 col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Your Assistant</h4>
                  <p class="card-category"></p>
                </div>
              </div>
              <div class="card-body">
                <div class="card2 " id="conversationdiv" style="border: 1px solid rebeccapurple;">

                  <div class=" msg_card_body" id="div1" style="border: 1px solid purple; position: relative; height: 90%; margin-top:1%; "></div>

                  <button style="margin-left:45%; margin-bottom: 1%;" id="record-btn" class="sendbtn">
            ...
            <div class="col-lg-4 col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">
                    Check status of your orderd item
                  </p>
                </div>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      foreach ($rows as $data) {
                        ...
                        <tr>';
                        echo '<td>' . $i . '</td>
                          <td>' . $data['doc']['fooditem'] . '</td>
                          <td>Rs ' . $data['doc']['price'] . '</td>';
                        if ($data['doc']['status'] == "True") {
                          echo '<td><span class="btn btn-sm btn-success text-bold">Out for Serve</span>
                            </td>';
                        } else {
                          echo '<td><span class="btn btn-sm btn-default ">Processing</span>
                            </td>';
                        }
                        echo '</tr>';
                        $i++;
