                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title">CrewTube</h4>
                                    <p class="card-category">
                                        Watch out all new web series on CrewTube
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="card card-cascade card-ecommerce narrower col-md-2">
                                    ...
                                    <div class="card-body card-body-cascade text-center">
                                        <!--Category & Title-->
                                        <h5>Pinjabi Music</h5>
                                        <h4 class="card-title"><strong><a href="">Sip Sip</a></strong></h4>
                                        <!--Card footer-->
                                        <div class="card-footer">
                                            <span class="float-left">4 min</span>
